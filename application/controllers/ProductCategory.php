...
class ProductCategory extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $data['customjs']              = "productcategory/customjs";
        $data['view']                  = "productcategory/index";
        $data['parent_module']         = $this->ProductCategory_model->generateParent();
    ...
    {
        $data['data'] = $this->ProductCategory_model->generateAll();
    ...
    function deactivate($categoryId)
    {
        ...
        $this->ProductCategory_model->updateCategory($data, $kondisi);
    }
        ...
        if (!empty($_FILES['categoryImage']['name'])) {
            if ($this->upload->do_upload('categoryImage')) {
                ...
                $datasave = array(
                    ...
                    "categoryId"            => $this->ProductCategory_model->getMaxId()
                );
                $this->ProductCategory_model->saveCategory($datasave, $categoryId);
    ...
    function updateCategory()
    {
        ...
        if (!empty($_FILES['editcategoryImage']['name'])) {
            if ($this->upload->do_upload('editcategoryImage')) {
                ...
                $this->ProductCategory_model->updateCategoryImg($dataupdate, $categoryId);
            ...
            $this->ProductCategory_model->updateCategoryNoImg($dataupdate, $categoryId);
