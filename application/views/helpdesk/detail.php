                ...
                <div class="direct-chat-messages">
                  ...
                  foreach ($list as $key) {
                      ...
                      <div class="direct-chat-msg right">
                          <span class="direct-chat-name float-right"><?php if($user == $key->penanya) { echo "Saya"; }else{echo "Admin";}?></span>
                     ...
                     <div class="direct-chat-msg">
                        <span class="direct-chat-name float-left"><?php if($user == $key->penanya) { echo "Saya";}else{echo "Admin";}?></span>
