            ...
            <tbody>
                <tr>
                    <td style="text-align:center;vertical-align:top;direction:ltr;font-size:0px;padding:9px 0px 9px 0px;">
                        ...
                        <!-- Start Logo LF top -->
                        <center><a href="https://rpgroup.co.id/new-arrival-lf/"><img src="<?=base_url();?>assets/app_assets/lf_logo.png" style="width:20%; height:20%; margin-top:50px;"></a></center></span></span></span></span>
                        <!-- End Logo LF top -->
