     ...
     dom: 'Bfrtip',
      buttons: 
        [
         ...
         "bProcessing": true,
         "sAjaxSource": "<?=base_url();?>Notification/getNotification",
         "aoColumns": 
            [
              { mData: 'notificationId' } ,
              { mData: 'notificationTitle' } ,
              { mData: 'notificationBody' } ,
              {
                "mData": null,
                "bSortable": false,
                "mRender": function(data, type, full) 
                  { return "<img width='90px' height='90px' src='<?php echo base_url().'assets/app_assets/'?>"+full.notificationImage+ "'>" }
              } , 
