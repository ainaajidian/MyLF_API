...
class ProductCategory_model extends CI_Model
{
    ...
    {
    	return $this->db->query("SELECT categoryId, categoryName, categoryImage,
                                 categoryDescription, categoryFlag, parentCategoryId
                                 FROM product_categories ORDER BY categoryId ASC")->result();
    }
