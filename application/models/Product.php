...
class Product extends MY_Controller
{
 ...
 //    function deleteColor($productId,$productColorId)
	...
	function addstok($productId, $categoryId)
	{
		...
		$data['sizes']			= $this->db->query("SELECT * FROM size a inner join ProductSize b on a.SizeID = b.SizeID where productId = '" . $productId . "' group by productId,a.sizeID ")->result();
